export const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  "99.9% Uptime": "Our infrastructure is designed for maximum reliability, ensuring your bot is always online.",
  "Auto-Restart": "If your bot crashes, our system will automatically restart it to minimize downtime.",
  "Custom Database": "Support for setting up and managing your own custom databases for bot data storage.",
  "RAM": "Random Access Memory used to handle active processes and data for your server.",
  "CPU": "Central Processing Unit power allocated to your server for calculations and logic.",
  "Storage": "High-speed NVMe or SSD storage for your files, databases, and world data."
};
