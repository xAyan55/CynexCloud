      ...
      <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="border-border">
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg bg-muted p-4">
                ...
                <p className="text-sm text-muted-foreground">Ticket created. Waiting for support response.</p>
              </div>
            </CardContent>
          </Card>
          <Card className="border-border">
        ...
        <Card className="border-border h-fit">
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <Separator />
            <div className="flex justify-between"><span className="text-muted-foreground">Created</span><span className="text-foreground">Today</span></div>
          </CardContent>
        </Card>
      </div>
    </div>
