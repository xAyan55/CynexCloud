...
async function startServer() {
  ...
  app.get("/api/plans", async (req, res) => {
    try {
      ...
      const vpsSeedPlans = [
        { id: "bronze", name: "Bronze", price: "₹99", price_numeric: 99, description: "Entry-level VPS for lightweight tasks and personal projects.", ram: "4GB", cpu: "1 Core", storage: "20GB SSD", cpuCores: 1, memoryMb: 4096, storageGb: 20, features: ["LXC Virtualization", "Root Access", "Shared IP", "SSD Storage"], popular: false, image: "/images/vps-imgs/bronze.png", category: "vps" },
        { id: "silver", name: "Silver", price: "₹199", price_numeric: 199, description: "Great value for small websites and development environments.", ram: "8GB", cpu: "2 Core", storage: "40GB SSD", cpuCores: 2, memoryMb: 8192, storageGb: 40, features: ["LXC Virtualization", "Root Access", "Shared IP", "SSD Storage"], popular: false, image: "/images/vps-imgs/silver.png", category: "vps" },
        { id: "platinum", name: "Platinum", price: "₹299", price_numeric: 299, description: "Balanced performance for growing applications.", ram: "12GB", cpu: "3 Core", storage: "60GB SSD", cpuCores: 3, memoryMb: 12288, storageGb: 60, features: ["LXC Virtualization", "Root Access", "Shared IP", "Snapshot Backups"], popular: false, image: "/images/vps-imgs/platinum.png", category: "vps" },
        { id: "gold", name: "Gold", price: "₹399", price_numeric: 399, description: "High-performance VPS for production workloads.", ram: "16GB", cpu: "4 Core", storage: "80GB SSD", cpuCores: 4, memoryMb: 16384, storageGb: 80, features: ["LXC Virtualization", "Root Access", "Shared IP", "Snapshot Backups"], popular: true, popularText: "RECOMMENDED", image: "/images/vps-imgs/gold.png", category: "vps" },
        { id: "diamond", name: "Diamond", price: "₹499", price_numeric: 499, description: "Premium resources for demanding applications.", ram: "20GB", cpu: "5 Core", storage: "100GB SSD", cpuCores: 5, memoryMb: 20480, storageGb: 100, features: ["LXC Virtualization", "Root Access", "Shared IP", "Daily Backups"], popular: false, image: "/images/vps-imgs/diamond.png", category: "vps" },
        { id: "crystal", name: "Crystal", price: "₹599", price_numeric: 599, description: "Enterprise-grade power for high-traffic platforms.", ram: "24GB", cpu: "6 Core", storage: "120GB SSD", cpuCores: 6, memoryMb: 24576, storageGb: 120, features: ["LXC Virtualization", "Root Access", "Shared IP", "Daily Backups", "Priority Support"], popular: false, image: "/images/vps-imgs/crystal.png", category: "vps" },
        { id: "amber", name: "Amber", price: "₹699", price_numeric: 699, description: "Maximum resources for the most demanding workloads.", ram: "28GB", cpu: "7 Core", storage: "140GB SSD", cpuCores: 7, memoryMb: 28672, storageGb: 140, features: ["LXC Virtualization", "Root Access", "Shared IP", "Daily Backups", "Priority Support", "10Gbps Uplink"], popular: false, image: "/images/vps-imgs/amber.png", category: "vps" }
      ];
